...
export default function Layout() {
	...
	useEffect(() => {
		...
		notificationListener.current = NotificationProvider?.Notifications.addNotificationReceivedListener(notification => {
			setNotification(notification);
		});

		responseListener.current = NotificationProvider?.Notifications.addNotificationResponseReceivedListener(response => {
